...
OnResult = () => {
    ...
    document.getElementById("yr-result001").innerHTML = getYear % 4 != 0 && getYear % 100 == 0 || getYear % 400 != 0 && getYear == '' ? '...' :  "previous leap year: " + prevLeapYear + " next leap year: " + nextLeapYear;
}
